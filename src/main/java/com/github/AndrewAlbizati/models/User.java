...
public record User(long discordId, String firstName, String lastName, String email, Date birthday, Date joinDate, boolean active, PrivilegeLevel privilegeLevel) {
    public static User fromId(Connection conn, long id) {
        try {
    ...
    public boolean addToDatabase(Connection conn) {
        try {
